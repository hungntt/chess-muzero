...
class MuZeroConfig:
    def __init__(self):
        ...
        self.training_steps = 550000  # Total number of training steps (ie weights update according to a batch)
        ...
        self.num_unroll_steps = 35  # Number of game moves to keep for every batch element
