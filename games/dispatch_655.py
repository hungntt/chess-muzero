...
class MuZeroConfig:
    def __init__(self):
        ...
        self.logger_path = os.path.join(self.results_path,
                                        "./logger.txt")  # Path to store the model weights and TensorBoard logs
        self.save_model = True  # Save the checkpoint in results_path as model.checkpoint
        self.training_steps = 450000  # Total number of training steps (ie weights update according to a batch)
