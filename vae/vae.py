...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # Is log variance not std - breaks existing models if changed
        z_log_standard_deviation = self.z_fully_connected_log_standard_deviation(x)
...
class VAE(nn.Module):
    ...
    @staticmethod
    def sample_reparametarization(mean, log_variance):
