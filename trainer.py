...
class Trainer:
    ...
    def update_weights(self, batch):
        ...
        # Convert list to tensor with corresponding device
        if self.config.PER:
        ...
        for i in range(1, action_batch.shape[1]):
            value, reward, policy_logits, hidden_state = self.model.recurrent_inference(hidden_state,
                                                                                        action_batch[:, i])
        ...
        # Calculate a scalar value. With batch=64, return value_scalar.shape = (64,)
        pred_value_scalar = (
